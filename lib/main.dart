...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> scan() async {
    ...
    if (Theme
      ...
      license = "";
    }
    ...
    try {
      ...
      print("AAAAAAAAAAAAAAAADADADADADADADADADADDADADADADADDADADADADADAD");
      for (var result in results) {
        if (result is BlinkIdMultiSideRecognizerResult) {
          setName(result.firstName?.description, result.lastName?.description);
        }
      }
      print(recognizer.toJson());
      print("AAAAAAAAAAAAAAAADADADADADADADADADADDADADADADADDADADADADADAD");
